...
<p style="color:#b5b5b5; font-family:'Roboto Condensed'; font-size:16px; font-weight: 300;">Acesse diretamente ao seu certificado digital atestando da sua participação nos 2 dias de palestras do Darkmira Tour PHP 2016 : <br/><br/><a style="color:#1c9547; text-decoration:underline;" href="https://certificado.darkmira.com/2016/XXXX">https://certificado.darkmira.com/2016/XXXX</a></p>

<p style="color:#b5b5b5; font-family:'Roboto Condensed'; font-size:16px; font-weight: 300;">Além desse link, você também pode compartilhar o seu certificado com seu empregador ou para uma contratação, através do outro link abaixo com o numero do seu certificado XXXXX</p>
...
die($insideBody);
$body = sprintf("This is the mail content. Dear %s %s. You can find your certification at the following url: %s", $alumni->getFirstName(), $alumni->getLastName(), $alumni->getUrl());